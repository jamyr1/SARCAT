...
var chartStats = function(records) {
  ...
  context.drawGraph = function(d, cont) {
    ...
    var container = cont.append("div").attr("class", klass);
    //.append('div')
  ...
  context.drawBars = function(record, svg) {
    ...
    var getWidth = function() {
      return widths.reduce(function(d, e) {
        return d + e;
      });
    };
...
var recordsSetMap = function(context, data) {
  ...
  legend.onAdd = function() {
    ...
    mapPoints.forEach(function(d) {
      div.innerHTML +=
        '<div class="statLegend"><div class="small">' +
        d.text +
        '</div><div class="fa-marker ' +
        d.bg +
        '"></div></div>';
    });
    return div;
  ...
  function ipp2find(d, feature) {
    ...
    var latlngs = [[lng0, lat0], [lng1, lat1]];
...
Template.stats.helpers({
  ...
  stats: function() {
    ...
    var data = records.filter(function(d) {
      return d._id === Session.get("activeRecord");
    });
