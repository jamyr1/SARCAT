Meteor.startup(function() {
  ...
  Tracker.autorun(function() {
    var getRecords = Session.get("getRecords");
    ...
    Tracker.nonreactive(function() {
      ...
      Meteor.call("getRecords", function(e, d) {
        d = d || [];
        Session.set("records", d);
        Session.set("loading");
      });
    });
  });
...
Router.configure({
  ...
  waitOn: function() {
    return [Meteor.subscribe("config"), Meteor.subscribe("roles")];
  },
  onBeforeAction: function() {
    if (Config.findOne({ initSetup: true })) {
